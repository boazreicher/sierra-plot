...
export class Timer {
    ...
    static getInstance(panelOptions: SierraPlotOptions, groups: Record<string, boolean>, chartCoordinates: Record<string, Coordinates>, onOptionsChange: optionsChangeCallback): Timer {
        if (!Timer.instance) {
    ...
    private static setInstance(panelOptions: SierraPlotOptions, groups: Record<string, boolean>, chartCoordinates: Record<string, Coordinates>, onOptionsChange: optionsChangeCallback): void {
