...
export abstract class ChartData {
  ...
  private calculateChartElements(panelOptions: SierraPlotOptions, sierraPlotProperties: SierraPlotProperties) {
    ...
    this.elements = chart.buildSvgElements(this.data, this.getNumDataPoints(), this.getChartsPresentationProperties(sierraPlotProperties, panelOptions))
  }
  ...
  protected abstract getChartsPresentationProperties(sierraPlotProperties: SierraPlotProperties, panelOptions: SierraPlotOptions): ChartsPresentationProperties
  protected abstract getChartLabel(sierraPlotProperties: SierraPlotProperties, panelOptions: SierraPlotOptions): ChartLabel
}
