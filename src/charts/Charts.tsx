...
export class Charts {
    ...
    constructor(charts: ChartData[], totals: Totals, properties: SierraPlotProperties, panelOptions: SierraPlotOptions) {
        this.charts = charts
        this.totals = totals
        this.totalChart = new TotalChartData(TOTAL_ELEMENT_ID, undefined, panelOptions.chartsFieldBreakdown, panelOptions.totalChartType)
    ...
    private buildCharts(sierraPlotProperties: SierraPlotProperties, panelOptions: SierraPlotOptions) {
        this.charts.forEach(chart => {
            ...
            let selectedGroup = panelOptions.selectedChart !== undefined && panelOptions.selectedChart.active && panelOptions.selectedChart.type == SelectionType.Group ? panelOptions.selectedChart.value : UNKNOWN_SELECTION_VALUE
