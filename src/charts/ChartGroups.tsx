...
export class ChartGroups implements PresentationElement{
    ...
    constructor(charts: ChartData[], sierraPlotProperties: SierraPlotProperties, panelOptions: SierraPlotOptions, onOptionsChange: optionsChangeCallback) {
    ...
    private addBoundsForGroup(sortKey: string, dimensionsForStackedAreaChart: Dimensions) {
        ...
        if (this.get(sortKey).boundingBox.minX == -1 || this.get(sortKey).boundingBox.minX > dimensionsForStackedAreaChart.startX) {
        ...
        if (this.get(sortKey).boundingBox.minY == -1 || this.get(sortKey).boundingBox.minY > dimensionsForStackedAreaChart.startY) {
