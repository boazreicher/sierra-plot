...
export class Markers implements PresentationElement {
  ...
  private formatTimestamp(timestamp: Date): string {
    return (
      ...
      '-' +
      this.addPadding(timestamp.getMonth() + 1, 2) +
      '-' +
      this.addPadding(timestamp.getDate(), 2) +
      ' ' +
      this.addPadding(timestamp.getHours(), 2) +
      ':' +
      this.addPadding(timestamp.getMinutes(), 2) +
      ':' +
      this.addPadding(timestamp.getSeconds(), 2)
    );
  }
