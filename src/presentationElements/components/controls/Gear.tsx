...
function createGear(chartsSvgElements: ChartsSvgElements, panelOptions: SierraPlotOptions, onOptionsChange: optionsChangeCallback) {
    ...
    return <svg
        ...
        xmlns="http://www.w3.org/2000/svg" x={startX - 100} y={getGearYPosition(startY, panelOptions.showControlElements, panelOptions.showRangeSelector)}>
        <g className={CLICKABLE_CLASS} onClick={getGearOnClickHandler(panelOptions, onOptionsChange)}
...
function getGearOnClickHandler(panelOptions: SierraPlotOptions, onOptionsChange: optionsChangeCallback): React.MouseEventHandler<SVGSVGElement> | undefined {
