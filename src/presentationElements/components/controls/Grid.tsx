  ...
  return (
    ...
    >
      ...
      <path
        ...
        style={getStyleObj(
          'fill:none;stroke:' +
            getGridColor(panelOptions.gridlineEnabled) +
            ';stroke-width:0.258938;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1',
        )}
...
function getGridOnClickHandler(
  panelOptions: SierraPlotOptions,
  onOptionsChange: optionsChangeCallback,
