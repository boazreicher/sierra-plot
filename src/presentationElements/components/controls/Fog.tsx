  ...
  return (
    ...
    >
      <path
        id="fog"
        style={getStyleObj(
          'fill:url(#radialGradient10268);fill-opacity:1;stroke:' +
            getFogStroke(panelOptions.showFog) +
            ';stroke-width:0.649422;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1',
        )}
