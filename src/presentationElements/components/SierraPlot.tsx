  ...
  <>
    {isValid(props.panelOptions) ? (
      ...
      >
        ...
        <YAxis
          effectiveMaxY={sierraPlotProperties.totalsMaxY}
          totalStackMode={props.panelOptions.totalStackMode}
          enabled={props.panelOptions.showTotal}
          totalsDimensions={sierraPlotProperties.totalsDimensions}
        />
        <ControlElements
...
function initSierraPlotElements(
  panelOptions: SierraPlotOptions,
  ...
  sierraPlotProperties = initSierraPlotProperties(
    panelOptions,
    sortedCharts,
    totals,
    width,
...
function initSierraPlotProperties(
  panelOptions: SierraPlotOptions,
  ...
  return new SierraPlotProperties(
    panelOptions,
    sortedCharts,
    totals,
    baseDimensionsProperties,
