...
export function getOnClickHandlerForChart(
  panelOptions: SierraPlotOptions,
  ...
  let clickEventHandler: React.MouseEventHandler = (event) => {
    ...
    if (
      ...
      panelOptions.selectedChart.key === panelOptions.chartsFieldBreakdown &&
      panelOptions.selectedChart.value === chartName
    ) {
      panelOptions.selectedChart.deselect();
    } else {
...
export function getOnClickHandlerForGroupBounds(
  groupName: string,
