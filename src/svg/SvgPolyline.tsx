...
export class SvgPolyline extends SvgElement {
    ...
    buildElement(height?: number): JSX.Element {
        return <polyline id={this.id} fill={this.fill} fillOpacity={this.fillOpacity} stroke={this.stroke} strokeOpacity={this.strokeOpacity} strokeWidth={this.strokeWidth} filter={this.filter} points={this.getPointsAsString(height)} />
    }
