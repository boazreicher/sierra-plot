...
export class SvgPolygon extends SvgElement {
    ...
    buildElement(height?: number): JSX.Element {
        return <polygon className={CLICKABLE_CLASS} id={this.id} onClick={this.onClick} onDoubleClick={this.onDoubleClick} onWheel={this.onWheel} onDrag={this.onDrag} fill={this.fill} fillOpacity={this.fillOpacity} stroke={this.stroke} strokeWidth={this.strokeWidth} filter={this.filter} points={this.getPointsAsString(height)} >
        </polygon>
    }
